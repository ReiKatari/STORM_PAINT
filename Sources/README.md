...
<p align="center">
  <b>Продвинутый инженерный и финансовый калькулятор с поддержкой матриц и графиков функций.</b>
</p>

[![Version](https://img.shields.io/badge/version-1.0.0-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_PAINT)
[![Platform](https://img.shields.io/badge/Platform-Windows%2011%20%7C%2010-0EA5E9.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_PAINT)
[![Tech](https://img.shields.io/badge/Tech-Python+%2f+PyQt6+%2f+NumPy-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_PAINT)
...
**STORM CALCULATOR** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
...
1. Запустите файл STORM_STORM_CALCULATOR_1.0.0_Setup.exe.
2. Выберите режим:
   * **Стандартная установка** — установка в C:\Program Files\STORM CALCULATOR с созданием ярлыков и регистрацией в системе.
